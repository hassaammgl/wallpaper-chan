...
export async function uploadToImageKit(file, { folder = "/wallpapers", onProgress } = {}) {
    ...
    const publicKey = configRes.data.data.imagekit?.publicKey || import.meta.env.VITE_IK_PUBLIC_KEY;
...
export async function uploadToCloudinary(file, { onProgress } = {}) {
    const { data: signRes } = await apiRequest.get("/api/upload/cloudinary/sign");
