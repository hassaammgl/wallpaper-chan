...
function Workspace({previewImg}) {
  ...
  return (
    <div className="flex-[3] flex items-center justify-center bg-[#e9e9e9] py-16">
      <div className="w-[375px] rounded-[32px] overflow-hidden flex items-center justify-center relative bg-gray-500"
        style={{
      ...
      >
        ...
        {textOptions.text && (
          <div className="absolute z-[999] max-w-full border border-dashed border-red-500"
            style={{
